...
//formulario para crear una granja con solo una raza
...
export default function GranjaForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch("/api/auth/granja", {
                method: "POST",
                headers: {
    ...
    return (
        <div className="container mx-auto p-6">
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto bg-white p-8 border shadow-md rounded-lg">
                <div className="mb-4">
                    <label htmlFor="nombre_granja" className="block text-gray-700 text-sm font-bold mb-2">
                        Nombre de la Granja
                    </label>
                    <input
                        type="text"
                ...
                <div className="mb-4">
                    <label className="block text-black text-sm font-bold mb-2">Seleccione una o varias razas:</label>
                    {razas.map((raza) => (
                        <div key={raza.id_raza} className="flex text-black items-center mb-2">
                            <input
                                type="checkbox"
                                id={`raza-${raza.id_raza}`}
                                name="razas"
                                value={raza.id_raza}
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link href="/dashboard/granja" className="text-blue-500 hover:underline">
                        Cancelar
                    </Link>
                </div>
            </form>
